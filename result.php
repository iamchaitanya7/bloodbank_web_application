	...
	<!-- navigation -->
		...
		<section class="agileits about-page">
			<div class="container">
                ...
                <div class="col-md-12 w3ls-about-top-left-grid">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script> <!----This link is important for dependent drop drop----------------->
                       <div > <?php
						...
						while($row=mysqli_fetch_array($res))
						{
							...
							<td><a href="email.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email'] ?>" title="Send Mail" class="btn btn-info glyphicon glyphicon-edit">Send Email</a>
                            </tr>
                            <?php
						}
						}
