                ...
                <div class="col-md-8 w3ls-about-top-left-grid">
                    ...
                    <?php
                      ...
                      <?php /*?>  <input type="radio" name="gender" value="Male<?php if($row['gender']=='Male') echo 'checked="checked"';?>"  >Male&nbsp;&nbsp;&nbsp;<input type="radio" class="" name="gender" value="Female<?php if($row['gender']=='Female') echo 'checked="checked"';?>" >Female<?php */?></td></tr>
                        ...
                        <tr><td>Blood Group</td><td><input type="text" class="form-control validate[required]" name="blood_group"  value="<?php echo $row['blood_group']; ?>"></td></tr>
...
$temp=$_FILES['photo']['tmp_name'];
	if($name)
		...
		$sql='update donor_registration set donor_name="'.$_POST['donor_name'].'",gender="'.$_POST['gender'].'",age="'.$_POST['age'].'",blood_group="'.$_POST['blood_group'].'",email="'.$_POST['email'].'",mobile_no="'.$_POST['mobile_no'].'",img="'.$userpic.'" where email="'.$_SESSION['email'].'"';
		echo $sql;
