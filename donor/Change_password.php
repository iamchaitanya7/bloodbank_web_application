...
<body>
	...
	<!-- navigation -->
		...
		<section class="agileits about-page">
		  ...
		  {
			$query='select * from donor_registration where email="'.$_SESSION['email'].'" and password="'.$_POST['pass'].'"';
			...
			if(mysqli_num_rows($res)>0)
			{
				if(strlen($_POST['pass1'])>=6)
				{
					...
					{
					$query1='update donor_registration set password="'.$_POST['pass1'].'",cpassword="'.$_POST['pass1'].'" where email="'.$_SESSION['email'].'"';
