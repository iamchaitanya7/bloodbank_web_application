...
<body>
	...
	<!-- navigation -->
		...
		<section class="agileits about-page">
			<div class="container">
				<h2 class="agile-inner-title">Donate Blood</h2>
                ...
                <div class="col-md-10 w3ls-about-top-left-grid">
					<div class="panel panel-primary" style="color:#000">
  					<div class="panel-heading" align="center" style="font-size:24px">Donate Blood</div>
...
<td><a href="donated_blood.php?id=<?php echo $row['id']; ?>&donor_name=<?php echo $row['donor_name']; ?>&email=<?php echo $row['email']; ?>&mobile_no=<?php echo $row['mobile_no']; ?>" class="btn btn-warning"> Edit</a></td>
</tr>
<?php
}
?></tbody>
