...
{ 
					   ...
					   <tr><td>Enter Your Name</td><td><input type="text" value="" name="name" required class="form-control"></td></tr>
					   <tr><td>Enter Your Mobile No</td><td><input type="text" value="" name="mobile_no" required class="form-control"></td></tr>
					   <tr><td>Required Blood Group</td><td><input type="text" value="" name="blood_group" required class="form-control"></td></tr>
					   
					   <tr><td>Required date</td><td><input type="date" value="" name="date" required class="form-control"></td></tr>
					   <tr><td colspan="2" align="center"><input type="submit" name="send" value="Send Mail" class="btn btn-success"></td></tr>
					   </table>
					   </form>
					    <?php
						}?>
