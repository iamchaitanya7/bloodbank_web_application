...
if(isset($_GET['id']))
{ 
$query='select * from state where id="'.$_GET['id'].'"';
...
?>
                   <form method="post" action="">
                            ...
                            <td>State Name</td><td><input type="text" name="state" class="form-control" value="
            ...
            CKEDITOR.replace( 'des' );
							...
							{
								extract($_POST);
							$query="update state set state='".$_POST['state']."' where id=".$_GET['id'];
