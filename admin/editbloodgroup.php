...
if(isset($_GET['id']))
{ 
$query='select * from bloodgroup where id="'.$_GET['id'].'"';
...
?>
                   <form method="post" action="">
                            ...
                            <td>BloodGroup</td><td><input type="text" name="bloodgroup" class="form-control" value="
							<?php echo $row['bloodgroupname']; ?>"></td></tr>
            ...
            CKEDITOR.replace( 'des' );
							...
							{
								extract($_POST);
							$query="update bloodgroup set bloodgroupname='".$_POST['bloodgroup']."' where id=".$_GET['id'];
