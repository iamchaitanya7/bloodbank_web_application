       ...
       <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="addstate.php"><i class="fa fa-qrcode"></i> Add State</a>
                    </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							if(isset($_POST['save']))
							{
							$query='insert into state(state)values("'.$_POST["state"].'")';
							...
							if(mysqli_num_rows($res1)>=1)
							{
								...
								?>	
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            </a>&nbsp; &nbsp;<a href="deletestate.php?id=<?php echo $row['id']; ?>" title="Delete" class="btn btn-danger glyphicon glyphicon-trash"> </a></td>
                                        </tr>
                                        <?php
                                }
							}
