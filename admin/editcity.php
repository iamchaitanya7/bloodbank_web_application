        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="addcity.php"><i class="fa fa-list"></i> Add City</a>
                    </li>
                    <li>
                        <a href="addstate.php"><i class="fa fa-qrcode"></i> Add State</a>
                    </li>
                    <li>
...
if(isset($_GET['id']))
{ 
$query='select * from addcity where id="'.$_GET['id'].'"';
$res=mysqli_query($con,$query);
$row=mysqli_fetch_array($res);
?>
                   <form method="post" action="">
                            <table class="table table-bordered">
                            <tr><td>City Name</td><td><input type="text" name="city_name" value="<?php echo $row['city_name']; ?>" class="form-control"></td></tr>
                            <tr><td>Pin Code</td><td><input type="text" name="pin_code" class="form-control" 
                            value="<?php echo $row['pin_code']; ?>"></td></tr>
                            <tr><td>District</td><td><input type="text" name="district" class="form-control" 
                            value="<?php echo $row['district']; ?>"></td></tr>
            ...
            CKEDITOR.replace( 'des' );
							...
							{
								extract($_POST);
							$query="update addcity set city_name='".$_POST['city_name']."',pin_code='".$_POST['pin_code']."',district='".$_POST['district']."',state='".$_POST['state']."' where id=".$_GET['id'];
							...
							if($res)
							{
								...
								echo "window.location.href='addcity.php';";
								echo "</script>";
							}
							else
							{
