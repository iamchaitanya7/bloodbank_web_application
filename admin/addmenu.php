...
//<![CDATA[
  ...
  <script>tinymce.init({ selector:'textarea' });</script>-->
                   ...
                   <form method="post" action="">
                            ...
                            <td>Menu Title</td><td><input type="text" name="menutitle" class="form-control"></td></tr>
                            <tr><td>Menu Description</td><td><textarea name="des"></textarea></td></tr>
            ...
            CKEDITOR.replace( 'des' );
							...
							{
								echo "<script>";
								echo "alert('Menu Added Successfully');";
								echo "window.location.href='addmenu.php';";
								echo "</script>";
							}
							else
							{
