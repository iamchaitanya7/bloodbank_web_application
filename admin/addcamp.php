...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script> --> <!----This link is important for dependent drop drop---------------->
                        <div class="panel-body">
                            ...
                            <tr><td>From</td><td><input type="date" name="frm_date" class="form-control"></td></tr>
                            <tr><td>To</td><td><input type="date" name="to_date" class="form-control"></td></tr>
                             <tr>
                <td>State</td>
                 <td>
...
$link=$_POST['link'];<?php */
							...
							$query='insert into addcamp(camp_title,organized_by,frm_date,to_date,state,district,city,img,type,description)values("'.$_POST["camp_title"].'","'.$_POST["organized_by"].'","'.$_POST["frm_date"].'","'.$_POST["to_date"].'","'.$_POST["state"].'","'.$_POST["district"].'","'.$_POST["city"].'","'.$name.'","'.$type.'","'.$_POST['description'].'")';
