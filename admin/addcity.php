                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <tr><td>City Name</td><td><input type="text" name="city_name" class="form-control"></td></tr>
                            <tr><td>Pin Code</td><td><input type="text" name="pin_code" class="form-control"></td></tr>
							...
							if(isset($_POST['save']))
							{
							$query='insert into addcity(city_name,pin_code,district,state)values("'.$_POST["city_name"].'","'.$_POST["pin_code"].'","'.$_POST["district"].'","'.$_POST["state"].'")';
							...
							if(mysqli_num_rows($res1)>=0)
							{
								...
								?>	
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="editcity.php?id=<?php echo $row['id']; ?>" title="Edit" class="btn btn-info glyphicon glyphicon-edit"> 
                                            </a>&nbsp; &nbsp;<a href="deletecity.php?id=<?php echo $row['id']; ?>" title="Delete" class="btn btn-danger glyphicon glyphicon-trash"> </a></td>
                                        </tr>
                                        <?php
                                }
							}
