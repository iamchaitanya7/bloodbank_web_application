...
if(isset($_GET['id']))
{ 
$query='select * from addmenu where id="'.$_GET['id'].'"';
...
?>
                   <form method="post" action="">
                            ...
                            <td>Menu Title</td><td><input type="text" name="menutitle" class="form-control" value="
							<?php echo $row['menu_name']; ?>"></td></tr>
                            <tr><td>Menu Description</td><td><textarea name="des"><?php echo $row['description'] ?></textarea></td></tr>
                            <tr><td colspan="2" align="center"><input type="submit" name="update" value="ADD NOW" class="btn btn-sm btn-success"></td>
                            </tr>
                            </table>
                            </form>
                            <?php
            ...
            CKEDITOR.replace( 'des' );
							...
							{
								extract($_POST);
							$query="update addmenu set description='".$_POST['des']."' where id=".$_GET['id'];
							...
							if($res)
							{
								...
								echo "window.location.href='viewmenu.php';";
								echo "</script>";
							}
							else
							{
								echo "<script>";
								echo "alert('Menu Not Updated  ');";
								echo "window.location.href='viewmenu.php';";
								echo "</script>";
							}
							}
